...
For detailed explanations and code examples for each rule, read:
`skills/composition-patterns/references/AGENTS.md`

---

*Source: [vercel-labs/agent-skills](https://github.com/vercel-labs/agent-skills/tree/main/skills/composition-patterns). MIT License.*
