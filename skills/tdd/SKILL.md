---
name: tdd
description: "Enforces test-driven development with RED-GREEN-REFACTOR cycle. Use when implementing features, fixing bugs, or refactoring code. Ensures 80%+ test coverage."
---

## Overview

TDD enforcement skill that owns the full test-driven development workflow and all reference content. Ensures all code is developed test-first with comprehensive coverage through the Red-Green-Refactor cycle.
